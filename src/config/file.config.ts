...
export default registerAs<FileConfig>('file', () => {
  ...
  return {
    ...
    maxFileSize: getValueOrDefault(process.env.AWS_S3_MAX_FILE_SIZE, 5242880),
    maxFileUpload: getValueOrDefault(process.env.AWS_S3_MAX_FILE_UPLOAD, 5),
  };
});
